### Descripcion 
```
jayyd@MacBook-Pro-de-Victor aa % nano fixme1.py

jayyd@MacBook-Pro-de-Victor aa % cat fixme1.py 
...
jayyd@MacBook-Pro-de-Victor aa % python3 fixme1.py
...
NOta = solamente se ejecuta el archivo de py, luego haces yun cat para poder cambiar y corregir el archivo, para asi darte la bandera.